  ...
  useEffect(() => {
    socket.on('callerDisconnect', () => {
         ...
         dispatch({ 
            ...
            payload: {error: `${call.username} est déconnecté(e)`} })
    })
    return () => socket.off('callerDisconnect')
  }, [dispatch, tracks, socket, call, addCallMessage, answer, total, newCall]);
    ...
    <div className="call_modal"> 
      ...
      >
        ...
        <div className="call_menu">
          <button
            className="material-icons text-danger p-2 bg-white rounded-circle pointer-event"
          ...
          {call.recipient === auth.user._id && !answer && (
            <>
              {call.video ? (
                <button
                  className="material-icons text-success p-2 bg-white rounded-circle"
                  style={{ cursor: "pointer" }}
      ...
      >
        ...
        <button
          className="material-icons text-danger p-2 bg-white rounded-circle pointer-event end_call"
          onClick={handleEndCall}
          style={{ cursor: "pointer" }}
        >
          call_end
